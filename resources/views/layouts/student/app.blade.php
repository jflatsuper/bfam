...
<header class="header clearfix">
    ...
    <div class="main_logo" id="logo">
        <a href="{{route('student.dashboard')}}"><img style="max-width: 100%;"  src="{{asset('images/bfam.png')}}" alt=""></a>
        <a href="{{route('student.dashboard')}}"><img class="logo-inverse" style="max-width: 100%;" src="{{asset('images/bfam.png')}}" alt=""></a>
    </div>
        ...
        <ul>
            <li class="ui dropdown">
                <a href="#" class="opts_account" title="Account">
                    <img src="{{\Illuminate\Support\Facades\Auth::user()->UserImage}}" alt="">
                </a>
...
<span class="uk-switch-button"></span>
                     ...
                     <a href="{{route('student.profile')}}" class="item channel_item">Profile</a>
...
<x-student-vertical-nav />



@if(Route::currentRouteName() == 'student.course-details' || Route::currentRouteName() == 'student.course-preview')
    @yield('content')
@else

                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row row-eq-height s3" >
                            <div class="col-lg-6 r7"  >
                                <input id="first_name" type="text" placeholder="First name" class="form-control fields r8 @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}" required autocomplete="first_name" autofocus>

...
<div class="row" style="padding-bottom: 80px;">
  <div class="col-lg-8" style="max-width: 100%;align-items:center;padding-bottom: 80px;">
...
<script src="https://unpkg.com/cloudinary-video-player@1.5.5/dist/cld-video-player.min.js" 
  ...
  <script>
    ...
    <div class="col-lg-8" style="max-width: 100%;height:auto;border-radius:10px;" id="z">
      <div  style="background-color:#dceee4;height:auto;border-radius:10px;margin-left:5%;margin-right:5%;">

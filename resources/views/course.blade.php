       ...
       <h5 style="margin-left:0%;">
          ...
          <p style="color: grey;margin:2%">
            ...
            <div style="width: 55%;overflow:hidden;padding-left:4%">{{ $data->CourseCreator}} </div>
             <div style="width: 40%;"><a style=" float:right;margin-left:2px"href="{{ route('deletes',['ids'=>$data->id])}}" class="btn btn-primary end"><i class="fa fa-minus" aria-hidden="true"></i></a>
           <a  style="float:right" href="{{ route('watcher',['id'=>$data->id])}}" class="btn btn-primary"><i class="fa fa-play" aria-hidden="true"></i></i></a>
             </div>
            </div>
          </p>
...
<div class="card-title" style="background-color:rgba(220,238,228, 0.5);padding-left:3%;padding-bottom:3%;">
    <h5 style="margin-left:0%;">
       ...
       <p style="color: grey;margin:2%">
         <div class="row">
         <div style="width: 55%;overflow:hidden;padding-left:4%">{{ $data->CourseCreator}} </div>
          <div style="width: 40%;"><a  style="float:right;margin-left:2px"href="{{ route('added',['id'=>$data->id])}}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> </a>

    ...
    <div class="course__form">
        <div class="general_info10">
            ...
            <div class="step-footer step-tab-pager mt-2">
                <button type="button" disabled wire:loading wire:target="addQuestion" class="btn btn-primary">
                    <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                </button>
                <button type="submit"  wire:loading.remove wire:target="addQuestion" class="btn btn-primary">
                    ADD QUESTION
                </button>

                <A href="{{route('admin.exam-list', $course->id)}}">
